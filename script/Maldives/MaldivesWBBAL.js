$(function() {
    $.ajax({
    "url": "http://api.worldbank.org/v2/countries/MDV/indicators/UIS.FOSEP.56.F400?date=2009:2015",
    "type": "get",
    "dataType": "xml",
    "success": function(data) {
       ...
       var wrapper = $('#wrapperWBBAL');
       
       wrapper.append('<h2>Chart of students in tertiary education enrolled in Business, Administration and Law programmes.</h2>');
