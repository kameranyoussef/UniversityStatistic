$(function() {
    $.ajax({
    "url": "http://api.worldbank.org/v2/countries/MDV/indicators/UIS.FOSEP.56.F800?date=2009:2015",
    "type": "get",
    "dataType": "xml",
    "success": function(data) {
       ...
       var wrapper = $('#wrapperWBAFFV');
       
       wrapper.append('<h2>Chart of students in tertiary education enrolled in Agriculture, Forestry, Fisheries and Veterinary programmes.</h2>');
