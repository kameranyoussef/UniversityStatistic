$(function() {
    $.ajax({
    "url": "http://api.worldbank.org/v2/countries/MCO/indicators/UIS.FOSEP.56.F200?date=2009:2015",
    "type": "get",
    "dataType": "xml",
    "success": function(data) {
       ...
       var wrapper = $('#wrapperWBAH');
       
       wrapper.append('<h2>Chart of students in tertiary education enrolled in Arts and Humanities programmes.</h2>');
