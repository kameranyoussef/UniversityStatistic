$(function() {
    $.ajax({
    "url": "http://api.worldbank.org/v2/countries/GBR/indicators/UIS.FOSEP.56.F300?date=2009:2015",
    "type": "get",
    "dataType": "xml",
    "success": function(data) {
       ...
       var wrapper = $('#wrapperWBSSJU');
       
       wrapper.append('<h2>Chart of students in tertiary education enrolled in Social Sciences, Journalism and Information programmes.</h2>');
