$(function() {
    $.ajax({
    "url": "http://api.worldbank.org/v2/countries/GBR/indicators/UIS.FOSEP.56.F700?date=2009:2015",
    "type": "get",
    "dataType": "xml",
    "success": function(data) {
       ...
       var wrapper = $('#wrapperWBEMC');
       
       wrapper.append('<h2>Chart of students in tertiary education enrolled in Engineering, Manufacturing and Construction programmes.</h2>');
