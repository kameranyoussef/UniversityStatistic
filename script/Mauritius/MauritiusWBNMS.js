$(function() {
    $.ajax({
    "url": "http://api.worldbank.org/v2/countries/MUS/indicators/UIS.FOSEP.56.F500?date=2009:2015",
    "type": "get",
    "dataType": "xml",
    "success": function(data) {
       ...
       var wrapper = $('#wrapperWBNMS');
       
       wrapper.append('<h2>Chart of students in tertiary education enrolled in Natural Sciences, Mathematics and Statistics programmes.</h2>');
