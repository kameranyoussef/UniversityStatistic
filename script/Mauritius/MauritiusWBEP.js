$(function() {
    $.ajax({
    "url": "http://api.worldbank.org/v2/countries/MUS/indicators/UIS.FOSEP.56.F140?date=2009:2015",
    "type": "get",
    "dataType": "xml",
    "success": function(data) {
       ...
       var wrapper = $('#wrapperWBEP');
       
       wrapper.append('<h2>Chart of students in tertiary education enrolled in Education programmes.</h2>');
